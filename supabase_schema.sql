...
\restrict kFm1HZaEG4bCvMJcy57Xf1cMsKgOROxG9iXi5TbhbGrsyL61hnpUKYCCZzKIInw
...
--
-- Name: location_clues; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.location_clues (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    location_id uuid,
    clue text NOT NULL
);
...
ALTER TABLE public.location_clues OWNER TO postgres;
...
--
-- Name: route_locations; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.route_locations OWNER TO postgres;
...
--
-- Name: team_routes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.team_routes OWNER TO postgres;
...
--
-- Name: location_clues location_clues_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.location_clues
    ADD CONSTRAINT location_clues_pkey PRIMARY KEY (id);
...
--
-- Name: route_locations route_locations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.route_locations
    ADD CONSTRAINT route_locations_pkey PRIMARY KEY (id);


--
-- Name: route_locations route_locations_route_id_round_number_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.route_locations
    ADD CONSTRAINT route_locations_route_id_round_number_key UNIQUE (route_id, round_number);
...
--
-- Name: team_routes team_routes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.team_routes
    ADD CONSTRAINT team_routes_pkey PRIMARY KEY (id);


--
-- Name: team_routes team_routes_team_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.team_routes
    ADD CONSTRAINT team_routes_team_id_key UNIQUE (team_id);
...
--
-- Name: sessions unique_owner_session; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_sessions_owner; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_sessions_owner ON public.sessions USING btree (owner_type, owner_id);
...
--
-- Name: location_clues location_clues_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.location_clues
    ADD CONSTRAINT location_clues_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.locations(id) ON DELETE CASCADE;
...
--
-- Name: route_locations route_locations_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.route_locations
    ADD CONSTRAINT route_locations_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.locations(id);


--
-- Name: route_locations route_locations_route_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.route_locations
    ADD CONSTRAINT route_locations_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id) ON DELETE CASCADE;
...
--
-- Name: team_routes team_routes_route_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.team_routes
    ADD CONSTRAINT team_routes_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id) ON DELETE CASCADE;


--
-- Name: team_routes team_routes_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.team_routes
    ADD CONSTRAINT team_routes_team_id_fkey FOREIGN KEY (team_id) REFERENCES public.teams(team_id) ON DELETE CASCADE;
...
--
-- Name: FUNCTION set_game_order_index(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE location_clues; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.location_clues TO anon;
GRANT ALL ON TABLE public.location_clues TO authenticated;
GRANT ALL ON TABLE public.location_clues TO service_role;
...
--
-- Name: TABLE route_locations; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.route_locations TO anon;
GRANT ALL ON TABLE public.route_locations TO authenticated;
GRANT ALL ON TABLE public.route_locations TO service_role;
...
--
-- Name: TABLE team_routes; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.team_routes TO anon;
GRANT ALL ON TABLE public.team_routes TO authenticated;
GRANT ALL ON TABLE public.team_routes TO service_role;
...
\unrestrict kFm1HZaEG4bCvMJcy57Xf1cMsKgOROxG9iXi5TbhbGrsyL61hnpUKYCCZzKIInw
